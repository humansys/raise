...
## Ãndice de Decisiones Arquitectónicas
...
| ADR-002 | Git como API de distribución | âœ… Accepted | 2025-12-26 |
| ADR-003 | MCP como protocolo de contexto | âœ… Accepted | 2025-12-26 |
| ADR-004 | Markdown para humanos, JSON para máquinas | âœ… Accepted | 2025-12-26 |
...
### Migración
- Término "DoD" â†’ "Validation Gate"
- Término "DoD Fractal" â†’ "Validation Gates por fase"
...
**Negativas:**
- Migración de archivos `raise-rules.json` â†’ `guardrails.json`
...
- **ADR-007 Nuevo**: "Rule" â†’ "Guardrail"
  - Migración: `raise-rules.json` â†’ `guardrails.json`
