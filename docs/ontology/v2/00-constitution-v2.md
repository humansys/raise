...
**RaiSE es** un framework metodológico para gobernar agentes de IA en el desarrollo de software empresarial. Es una herramienta de **Context Engineering** que aplica principios Lean al desarrollo AI-asistido.
...
> **Nota de enmienda:** Este principio se llamaba "Calidad Fractal (DoD en Cada Fase)" en v1.0. El concepto de fractalidad (gates a múltiples niveles de granularidad) se preserva.
