...
> **Nota de versión 2.0:** Visión actualizada con diferenciadores MCP-native, Observable Workflow, y terminología v2.0 (Validation Gates, Guardrails, Orquestador).
...
- **Opacidad de decisiones**: No hay forma de auditar *por qué* el agente tomó una decisión [NUEVO v2.0]
...
- **11,000+ MCP servers registrados** — MCP es el estándar de facto para Context Engineering [NUEVO v2.0]
...
### Cómo Funciona [ACTUALIZADO v2.0]
...
### Diferenciadores Clave [ACTUALIZADO v2.0]
...
### Value Props por Stakeholder [ACTUALIZADO v2.0]
...
- **No puede auditar decisiones de agentes** [NUEVO v2.0]
...
- **Generar reportes de Observable Workflow** [NUEVO v2.0]
...
- **Crecer como profesional, no atrofiarse** [NUEVO v2.0]
...
- **No sabe cuándo el agente tiene baja confianza** [NUEVO v2.0]
...
- **Responder a Escalation Gates de forma informada** [NUEVO v2.0]
...
6. **Observable Workflow comienza a registrar traces** [NUEVO v2.0]
...
3. `raise hydrate` sincroniza guardrails en cada repo
4. CI ejecuta `raise check` + `raise gate status` bloqueando non-compliance
5. **`raise audit --format json` genera reportes agregados** [NUEVO v2.0]
...
5. **Escalation Gate si agente tiene baja confianza** [NUEVO v2.0]
6. Kata final valida **Gate-Code**
7. **`raise audit` para revisar sesión** [NUEVO v2.0]
...
### CU-5: Escalation Gate en Acción [NUEVO v2.0]
...
## Competitive Positioning [ACTUALIZADO v2.0]
...
### Diferenciador Único [NUEVO v2.0]
...
## Roadmap de Alto Nivel [ACTUALIZADO v2.0]
...
- Roadmap alineado con ontología v2.0
