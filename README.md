...
> **Detailed instructions** for macOS, Linux, and Windows — including known pitfalls and troubleshooting — are in the **[Installation Guide](docs/installation.md)**.
...
| Skill | Purpose |
|-------|---------|
| `/rai-discover` | Run the full discovery pipeline and build the knowledge graph |
...
Current stable release: `v3.0.0`. The `v3.1.0` prerelease series is available
for early adopters.

We value your feedback:

- **Questions?** Open a [GitHub issue](https://github.com/humansys/raise/issues)
- **Found a bug?** Open a [GitHub issue](https://github.com/humansys/raise/issues) with reproduction steps
