...
> **Windows / Spanish-LATAM consoles:** if you see `UnicodeEncodeError`, set `$env:PYTHONUTF8 = "1"` in PowerShell (or `set PYTHONUTF8=1` in CMD) before running `rai`. See [Troubleshooting](docs/installation.md#troubleshooting).
