...
| S17.2 | PHP extractor | M | Pending | tree-sitter-php: classes, functions, interfaces, traits, methods |
| S17.3 | Svelte extractor | S | Pending | tree-sitter-svelte: script block symbols + component registration |
