...
- **Description:** Run full quality gates (ruff, pyright, bandit, tests). Then run `rai discover analyze` on a real scan to verify categories and module paths look correct for non-Python files.
