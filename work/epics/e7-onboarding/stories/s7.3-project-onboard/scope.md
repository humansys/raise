...
- Graph build gate: `rai memory build` produces architecture + governance nodes
- Skill file in `.claude/skills/project-onboard/`

**Out of Scope:**
- Changes to discovery CLI commands (already exist)
- Changes to `rai init` or governance templates (S7.1 done)
...
- [ ] `rai memory build` succeeds after onboarding
