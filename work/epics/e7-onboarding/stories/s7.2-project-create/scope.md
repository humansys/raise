...
- Run `rai memory build` as final gate — 30+ governance nodes
...
- `rai status` or `rai doctor` commands
...
- [ ] `rai memory build` produces 30+ governance nodes from generated content
