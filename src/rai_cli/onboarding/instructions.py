...
.windsurf/rules/raise.md, etc.) with detected conventions, project structure,
and references to governance artifacts.
"""
...
class InstructionsGenerator:
    """Generates agent instructions file content from detection results.

    Creates context-rich instructions that help the target agent understand
    ...
    def generate(
        ...
        *,
        ...
        Args:
            ...
            project_path: Optional project root path. When provided and a
                .raise/ directory exists, generates Rai-specific CLAUDE.md.
    ...
    # =========================================================================
    # Existing brownfield/greenfield generation
    # =========================================================================
    ...
    def _add_governance_section(self, lines: list[str]) -> None:
        ...
        lines.append("")
        lines.append("- `governance/guardrails.md` \u2014 Code standards and verification")
...
def generate_instructions(
    ...
    *,
    ...
    Args:
        ...
        project_path: Optional project root path for RaiSE project detection.
    ...
    Example:
        ...
        >>> content = generate_instructions("my-api", detection, conventions)
