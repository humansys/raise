"""Tests for McpBridge move to rai_cli.mcp.bridge (T1).
...
def test_canonical_import_tool_result() -> None:
    ...
    from rai_cli.mcp.bridge import McpToolResult
...
def test_canonical_import_tool_info() -> None:
    ...
    from rai_cli.mcp.bridge import McpToolInfo
...
def test_shim_import_error() -> None:
    ...
    from rai_cli.adapters.mcp_bridge import McpBridgeError
...
def test_shim_import_tool_info() -> None:
    ...
    from rai_cli.adapters.mcp_bridge import McpToolInfo
...
def test_canonical_and_shim_are_same_class() -> None:
    ...
    from rai_cli.adapters.mcp_bridge import McpBridge as ShimBridge
    from rai_cli.mcp.bridge import McpBridge as CanonicalBridge
