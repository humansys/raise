...
def _module_id_from_file(file: str) -> str | None:
    ...
    module name. Returns None for top-level files (no module subfolder) and
    for candidates that are not public module directories.
    ...
    Examples:
        ...
        ``packages/raise-partners/src/api/client.ts``              -> None
