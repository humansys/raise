...
class MetricsReport(BaseModel):
    ...
    Fields:
        ...
        module_id:      Module under analysis (e.g. "mod-discovery", or
                        "mod-raise-core--discovery" when package-qualified
                        in a packages/* monorepo — RAISE-16033).
    ...
    def compute(self, module_id: str) -> MetricsReport:
        ...
        Args:
            module_id: Module ID as stored in graph (e.g. "mod-discovery",
                or "mod-raise-core--discovery" — package-qualified ids in
                a packages/* monorepo, RAISE-16033).
