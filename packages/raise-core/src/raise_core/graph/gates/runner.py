...
def run_reconcile(config: GateConfig, domain: str = "unknown") -> GateResult:  # noqa: C901
...
def run_coverage(config: GateConfig, domain: str = "unknown") -> GateResult:  # noqa: C901
    ...
    def _run() -> GateResult:
        ...
        try:
            from rai_agent.scaleup.validation.models import CompetencyQuestion  # noqa: I001  # pyright: ignore[reportMissingImports]
