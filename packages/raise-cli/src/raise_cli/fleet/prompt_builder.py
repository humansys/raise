...
_ESSENTIAL_RULES = (
    ...
    "- MR Always Via /rai-mr-create — never create MRs with glab/gh "
    "directly. The skill synchronizes the target, verifies governance "
    "and CI contracts, and records admission evidence.\n"
