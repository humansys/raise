...
class CalibrationReport(BaseModel):
    ...
    healthy_n: int
    quantile: float
    thresholds: dict[str, float] = Field(default_factory=lambda: {})  # noqa: PIE807
    excluded: list[str] = Field(default_factory=lambda: [])  # noqa: PIE807
    excluded_metrics: list[str] = Field(default_factory=lambda: [])  # noqa: PIE807
