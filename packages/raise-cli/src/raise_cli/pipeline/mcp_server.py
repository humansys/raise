...
import raise_cli.pipeline.mcp_tools_artifact  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_backlog  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_docs  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_fleet  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_gate  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_graph  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_pattern  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_pipeline  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_session  # pyright: ignore[reportUnusedImport]
import raise_cli.pipeline.mcp_tools_story  # pyright: ignore[reportUnusedImport]
...
from raise_cli.pipeline.mcp_lifecycle import wire_mcp_lifecycle
...
def main() -> None:
    ...
    wire_mcp_lifecycle(mcp, server_root=project or "")
    mcp.run()
