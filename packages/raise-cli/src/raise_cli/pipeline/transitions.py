...
def resolve_transition_deps(
    ...
    Machine: derive_state_machine(project_root) from backlog.yaml.
      Returns empty_state_machine() when no workflow section exists.
      Never returns None (derive_state_machine never raises).
    """
