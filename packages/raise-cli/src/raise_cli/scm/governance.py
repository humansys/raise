...
def append_governance_block(
    ...
    """Append the block to an MR description, after the human-readable content.

    The block goes last, separated by a blank line, so it does not push the
    body down in the SCM UI.
