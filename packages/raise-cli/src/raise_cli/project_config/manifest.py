...
class BacklogConfig(ManifestModel):
    ...
    Empty placeholder — RAISE-16625 removed ``adapter_default`` (ghost config,
    never set by any command, superseded by the composite resolver's
    auto-detect + auto-compose behavior). Kept as a namespace for future
    backlog config (e.g., E5 projection config, sync frequency).
    """
