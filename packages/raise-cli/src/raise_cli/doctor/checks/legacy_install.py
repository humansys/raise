...
class LegacyInstallCheck(DoctorCheck):
    ...
    def evaluate(self, context: DoctorContext) -> list[CheckResult]:
        ...
        # developer-yaml family is owned by DeveloperYamlCheck (S16227.8) --
        # exclude here to avoid double-reporting the same residues.
        all_residues = [
            r for r in all_residues if FAMILY_BY_KIND[r.kind] != "developer-yaml"
        ]
