...
from raise_cli.exceptions import ConfigurationError, RaiSessionNotFoundError
...
def _normalize_session_id(session_id: str) -> str:
    ...
    # New format: S-{prefix}-{YYMMDD}-{HHMM}-{XXXX} (entropy suffix, RAISE-15482;
    # pre-fix ids without the suffix also pass through)
