...
def build_token_usage_daily_event(
    ...
    *,
    ...
    from raise_cli.telemetry.cost_report import PRICING, price_key
    ...
    # S16430.2 (SD3): close the cost_usd gap in this session-close variant —
    # build_replay_events already carries cost_usd per skill; this one didn't.
    pricing = PRICING[price_key(totals.model)]
    cost_usd = (
...
def build_story_cost_summary_event(
    ...
    *,
    ...
    payload: dict[str, object] = {
        ...
        "session_id": session_id,
        "tool_name": "raise-cli",  # S16430.2 (SD3) — multi-tool attribution
    }
