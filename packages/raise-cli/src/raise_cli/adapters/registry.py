...
# SCM adapter entry point group (S10724.4)
EP_SCM_ADAPTERS: str = "rai.adapters.scm"
...
def get_scm_adapters() -> dict[str, type]:
    """Discover ScmAdapter implementations."""
    return _discover(EP_SCM_ADAPTERS)
