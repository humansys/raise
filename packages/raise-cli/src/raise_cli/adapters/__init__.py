...
Public API: 6 Protocols + 16 boundary models + 2 sync wrappers
+ 4 registry functions + 4 group constants.
KnowledgeGraphBackend + BackendHealth moved to raise_core (E275).
GovernanceParser removed in S10328.7 — cartridge pipeline replaces it.
...
__all__ = [
    # Protocols — sync (3 local + 1 from raise_core)
    "DocumentationTarget",
    "GovernanceSchemaProvider",
