...
def pipeline_run_active() -> bool:
    ...
    Delegates to ``execution_context.any_pipeline_run_active`` (RAISE-16987).
    ...
    """
    from raise_cli.pipeline.execution_context import any_pipeline_run_active

    return any_pipeline_run_active()
