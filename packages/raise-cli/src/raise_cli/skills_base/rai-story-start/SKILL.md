...
Read `governance/guardrails.md` before drafting (graceful degradation: if absent, continue without blocking). Do not propose AC that violate project guardrails.
