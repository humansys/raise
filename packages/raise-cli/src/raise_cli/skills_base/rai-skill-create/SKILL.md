...
**CLI command convention:** Commands that rai doctor should validate go in ` ```bash ` blocks only. Inline backtick is for human-readable prose and is **not** validated.
