...
Use `raise_docs_write` MCP tool with doc_type="epic-docs", title="E{N}: {epic-name} — Developer Documentation", content="[assembled content from Steps 2-6]", output_path="work/epics/e{N}-{slug}/docs.md", cwd="{project_or_worktree_path}".
