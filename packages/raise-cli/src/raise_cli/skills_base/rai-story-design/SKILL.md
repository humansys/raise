...
4. **Code orientation**: Load SA-ranked code symbols for the current branch using the `raise_session_context` MCP tool with sections="code_context", `cwd="{project_or_worktree_path}"`.
...
6. **Backlog transition** — engine owned (RAISE-15034):
