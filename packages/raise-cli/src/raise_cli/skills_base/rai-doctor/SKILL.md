...
- **Shu**: Run diagnostics, explain each finding, and ask before fixes
- **Ha**: Group known warnings and recommend the shortest safe repair path
- **Ri**: Surface only blocking issues and run approved fixes directly
...
- Stale skills → offer to run rai skill check-updates
