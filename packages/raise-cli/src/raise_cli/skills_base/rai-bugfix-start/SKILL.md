...
Read `governance/guardrails.md` before writing the scope (graceful degradation: if absent, continue without blocking). Factor guardrails into the fix approach.
