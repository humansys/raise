...
metadata:
  ...
  raise.fase: ""
  raise.prerequisites: "rai init --detect, rai-discover"
...
Check that `/rai-discover` has been run:
...
| `DISCOVERY_MISSING` | Stop: "Run `/rai-discover` first to analyze the codebase, then come back to `/rai-project-onboard`." |
...
<verification>
Discovery artifacts exist. Existing docs read.
</verification>
