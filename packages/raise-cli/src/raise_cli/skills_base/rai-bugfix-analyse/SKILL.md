...
Use `raise_docs_write` MCP tool with doc_type="bugfix-analysis", title="{issue_key}: analysis", content="## Method: {method used}\n\n### Root Cause\n{root cause}\n\n### Evidence\n{evidence supporting root cause}\n\n### Fix Approach\n{one line}", output_path="work/bugs/{issue_key}/analysis.md", cwd="{project_or_worktree_path}".
