...
class CockpitApp(App[None]):
    ...
    def _start_recovery_rebase(self, worktree_id: str) -> None:
        ...
        dev = resolve_dev_branch(main_repo_root())
        spec = ProvisionSpec(
            slug=worktree_id,
            branch=worktree.branch,
            worktree_path=Path(worktree.path),
            merge_target=worktree.merge_target or dev,
            base_ref=worktree.merge_target or dev,
        )
        service = self._new_session_service or NewSessionService(main_repo_root())
    ...
    def action_close_session(self) -> None:
        ...
        merge_target = worktree.merge_target or resolve_dev_branch(main_repo_root())
