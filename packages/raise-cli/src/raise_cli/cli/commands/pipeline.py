...
def pipeline_start_cmd(
    ...
    work_type: Annotated[
        ...
        typer.Option(
            "--work-type",
            help=(
                "Work classification for target-branch resolution "
                "(RAISE-17066). Defaults to the pipeline name's leading "
                "token, e.g. 'bugfix-lean' -> 'bugfix'."
            ),
        ),
    ] = "",
    fix_version: Annotated[
        ...
        typer.Option(
            "--fix-version",
            help="Optional fixVersion (e.g. 3.1.1) mapped to a release line.",
        ),
    ] = "",
) -> None:
