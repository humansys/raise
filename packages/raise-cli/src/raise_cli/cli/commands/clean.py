...
def clean_command(
    ...
    yes: Annotated[
        ...
        typer.Option(
            "--yes",
            help=r"Skip \[y/N] confirmation. Not compatible with --force (does not skip --force confirmation).",
        ),
    ] = False,
    force: Annotated[
        bool,
        typer.Option(
            "--force",
            help="Include advisory residues (requires typing 'yes'). Not compatible with --yes. Requires interactive TTY.",
        ),
    ] = False,
