...
from raise_cli.cli.commands.docs_architecture import architecture_app
...
docs_app.add_typer(architecture_app, name="architecture")
...
def publish(
    ...
    project: Annotated[
        str | None,
        typer.Option("--project", help="Project identifier for the artifact"),
    ] = None,
    ...
    format: Annotated[
        ...
        typer.Option(
            "--format",
            help="Content format: 'markdown' (default) or 'html' (RAISE-16870)",
        ),
    ] = "markdown",
) -> None:
