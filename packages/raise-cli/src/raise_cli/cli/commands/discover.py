...
Supports Python, TypeScript, JavaScript, PHP, Svelte, C#, Dart, Java, and Go.
...
from raise_core.discovery.scanner import Language, ScanResult, scan_directory
...
def _validate_language(language: str | None) -> Language | None:
    ...
    if language not in _SUPPORTED_LANGUAGES:
        cli_error(
            ...
            hint="Supported: python, typescript, javascript, php, svelte, csharp, dart, java, go",
            exit_code=7,
        )
...
def scan_command(
    ...
    language: Annotated[
        ...
        typer.Option(
            "--language",
            "-l",
            help="Language to scan: python, typescript, javascript, php, svelte, csharp, dart, java, go (auto-detect if not set)",
        ),
    ] = None,
    output: Annotated[
        str,
    ...
    from source files. Supports Python, TypeScript, JavaScript, PHP, Svelte, C#, Dart, Java, and Go.
