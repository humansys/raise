...
class AgentConfig(BaseModel):
    ...
    Attributes:
        ...
        context_window: Maximum context window in tokens for this agent runtime.
    """
...
BUILTIN_AGENTS: dict[BuiltinAgentType, AgentConfig] = {
    ...
    "hermes": AgentConfig(
        ...
        detection_markers=["AGENTS.md", ".hermes"],
    ...
    "codex": AgentConfig(
        ...
        skills_dir=".agent/skills",
        instructions_file="AGENTS.md",
        detection_markers=["AGENTS.md", ".codex"],
        plugin="raise_cli.agents.codex_plugin",
    ...
    "kimi": AgentConfig(
        ...
        instructions_file="AGENTS.md",
        detection_markers=[".kimi-code"],
        plugin="raise_cli.agents.kimi_plugin",
    ),
    "devin": AgentConfig(
        name="Devin",
        agent_type="devin",
        skills_dir=".agents/skills",
        instructions_file="AGENTS.md",
        detection_markers=[".devin"],
        plugin="raise_cli.agents.devin_plugin",
    ),
    "bob": AgentConfig(
        name="Bob (IBM)",
        agent_type="bob",
        ...
        instructions_file="AGENTS.md",
        detection_markers=[".bob/custom_modes.yaml", ".bob"],
        plugin="raise_cli.agents.bob_plugin",
    ),
}
