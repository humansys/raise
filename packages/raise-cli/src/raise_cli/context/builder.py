...
from raise_cli.context.loaders.documents import load_documents as _load_documents
...
class GraphBuilder:
    ...
    def load_documents(self) -> list[GraphNode]:
        ...
        if manifest is None or manifest.graph is None:
            return []
        return _load_documents(self.project_root, manifest.graph.document_sources)
