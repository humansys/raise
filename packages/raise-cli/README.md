...
The global binary is the recommended method. These alternatives require Python 3.12+.
...
|---|---|---|
| **raise-cli** | `rai` CLI — sessions, graph, gates, pipelines, backlog | Global binary (see [Install](#install)) or `pip install raise-cli --pre` |
| **raise-core** | Core library — graph, memory, patterns, discovery | Bundled with the binary, or `pip install raise-core --pre` |
...
Current release: **v3.1.0-beta**. Install the [global binary](https://github.com/humansys/raise/releases/latest) for the latest, or `pip install raise-cli --pre`.

- **Questions or bugs?** [Open an issue](https://github.com/humansys/raise/releases/latest) (GitHub)
...
[Apache-2.0](https://github.com/humansys/raise/blob/main/LICENSE)
