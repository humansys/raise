...
type: module
name: skills_base
purpose: "Distributable skill collection — the 21 SKILL.md files that ship with rai-cli"
status: current
depends_on: []
...
The skills_base module packages the 21 RaiSE skills that ship with rai-cli. On `rai init`, the onboarding module copies these SKILL.md files into the project's `.claude/skills/` directory. After that, they're independent — the project's copies can be customized without affecting the base.
