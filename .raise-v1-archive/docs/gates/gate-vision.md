...
Verificar que la Solution Vision está completa, alinea negocio con técnica, y tiene la calidad necesaria para proceder a la Fase 3 (Technical Design).

## Cuándo Aplicar

- Después de completar `flujo-02-solution-vision`
- Antes de iniciar `flujo-03-tech-design`
- El documento debe existir en `.raise/specs/{proyecto}-vision.md`
...
> **Si falla:** Revisar PRD y Vision lado a lado. Documentar discrepancias.
...
> **Si falla:** Documentar qué no es factible y por qué. Escalar a Product Owner para re-priorizar.
...
> **Si falla:** Agendar sesión de alineamiento antes de continuar.
...
- Kata asociada: [`flujo-02-solution-vision`](../katas-v2.1/flujo/02-solution-vision.md)
- Template: [`solution-vision-template.md`](../templates/solution/solution-vision-template.md)
- Gate previo: [`gate-discovery`](./gate-discovery.md)
- Siguiente gate: [`gate-design`](./gate-design.md)
