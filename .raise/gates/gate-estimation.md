...
**Purpose**: Validate that `governance/estimation.md` is complete, accurate, and ready for Statement of Work generation.
...
2. Load `governance/backlog.md` and count Epics + Features + User Stories
